...
for _ in range(200):
    ...
    if(_==0):
        ...
        students_insert += after - before
print "Average for insert 200 students one by one is {}".format(students_insert/200)
#Faculty
...
for _ in range(20):
    ...
    if(_==0):
        ...
        faculty_insert += after - before 
print "Average for insert 20 faculty one by one is {}".format(faculty_insert/20)
deps=[
    'Math',
    'English',
    'Psychology',
...
for _ in range(10):
    ...
    dep_results = db.departments.insert_one({
        'dname':"{}".format(deps[random.randint(0,9)]),
        'did': _
        })
    after = datetime.now()
    if(_==0):
        ...
        departments_insert += after - before    
print "Average for inserting 10 departments one by one is {}".format(departments_insert/10)
#Insert courses
clas=[
    'CPSC4660',
    'PHIL1000',
...
for _ in range(40):
    ...
    if(_==0):
        ...
        classes_insert += after - before
print "Average for inserting 40 classes one by one is {}".format(classes_insert/40)
import pymongo
