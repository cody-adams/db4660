...
for _ in range(200):
    ...
    if (_==0):
        ...
        students_insert += after - before
print "Average time to insert a record into students 200 times is: {}".format(students_insert/200)
...
for _ in range(20):
    ...
    if (_==0):
        ...
        faculty_insert += after - before    
print "Average time to insert a record into faculty 20 times is: {}".format(faculty_insert/20)
deps=[
    'Math',
    'English',
    'Psychology',
...
for _ in range(10):
    ...
    if (_==0):
        ...
        depts_insert += after - before
print "Average time to insert a record into departments 10 times is: {}".format(depts_insert/10)
clas=[
    'CPSC4660',
    'PHIL1000',
    'JPN1000',
...
for _ in range(40):
    ...
    if (_==0):
        ...
        classes_insert += after - before
print "Average time to insert a record into classes 40 times is: {}".format(classes_insert/40)
cursor.execute("SELECT sid FROM students")
tmpcursor = cnx.cursor()
for (sid_value) in cursor:
    tmpcursor.execute("INSERT INTO takes (cno,sid) VALUES({},{})".format(random.randint(0,39),sid_value))
for _ in range(100):
    before = datetime.now()
