...
for _ in range(2000):
    ...
    if(_==0):
        ...
        students_insert += after - before
print "Average for insert 2000 students one by one is {}".format(students_insert/2000)
#Faculty
...
for _ in range(200):
    ...
    if(_==0):
        ...
        faculty_insert += after - before 
print "Average for insert 200 faculty one by one is {}".format(faculty_insert/200)
deps=[
    'Math',
    'English',
    'Psychology',
...
for _ in range(100):
    ...
    if(_==0):
        ...
        departments_insert += after - before    
print "Average for inserting 100 departments one by one is {}".format(departments_insert/100)
#Insert courses
clas=[
    'CPSC4660',
    'PHIL1000',
...
for _ in range(400):
    ...
    if(_==0):
        ...
        classes_insert += after - before
print "Average for inserting 400 classes one by one is {}".format(classes_insert/400)
import pymongo
